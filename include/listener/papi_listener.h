...
#pragma once
#ifndef PTM_UTIL_LISTENER_PAPI_LISTENER_H
#define PTM_UTIL_LISTENER_PAPI_LISTENER_H
...
namespace util::listener {
	...
	public:
		...
		~PAPIListener() override {
			...
			util::logger_print_property("PAPI Listener",
...
#endif //PTM_UTIL_LISTENER_PAPI_LISTENER_H
