...
#pragma once
#ifndef PTM_UTIL_LISTENER_PMEM_LISTENER_H
#define PTM_UTIL_LISTENER_PMEM_LISTENER_H
...
namespace util::listener {
	...
	public:
		...
		~PMMListener() override {
			...
			util::logger_print_property("PMMListener",
...
#endif //PTM_UTIL_LISTENER_PMEM_LISTENER_H
